package com.ousl.fearlessgrocery.adapters;
...
import com.ousl.fearlessgrocery.R;
import com.ousl.fearlessgrocery.model.Menu;
...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MenuListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view  = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_row_menu_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull MenuListAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.menuPrice.setText("LKR. "+menuList.get(position).getPrice()+"0");
